                        ...
                        <form role="form" action="${pageContext.request.contextPath}/admin/register" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nickname" placeholder="请输入昵称..."
                                       minlength="2" class="form-nickname form-control" id="form-nickname" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input style="padding-left:20px;width: 286px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       ...
                                       minlength="2" class="form-code form-control" id="form-code" required>
                                <input type="button" value="获取短信验证码" onclick="save()">
                            </div>
